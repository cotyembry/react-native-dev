...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receivedNotification) name:@"dismissViewController" object:nil];
...
-(void)receivedNotification {
  NSLog(@"received Notification was called");
}
